...
ClasssizeGPA <- function(size1, size2) {
gpa <- grade.data %>%
  filter(Student_Count >= size1 & Student_Count <= size2) %>%
...
ClasssizeLetterA <- function(size1, size2) {
...
ClasssizeLetterB <- function(size1, size2) {
  gpa <- grade.data.mutate %>%
    filter(Student_Count >= size1 & Student_Count <= size2) %>%
...
ClasssizeLetterC <- function(size1, size2) {
  gpa <- grade.data.mutate %>%
    filter(Student_Count >= size1 & Student_Count <= size2) %>%
...
ClasssizeLetterD <- function(size1, size2) {
  gpa <- grade.data.mutate %>%
    filter(Student_Count >= size1 & Student_Count <= size2) %>%
...
ClasssizeLetterF <- function(size1, size2) {
  gpa <- grade.data.mutate %>%
    filter(Student_Count >= size1 & Student_Count <= size2) %>%
...
ClasssizeLetterW <- function(size1, size2) {
  gpa <- grade.data.mutate %>%
    filter(Student_Count >= size1 & Student_Count <= size2) %>%
